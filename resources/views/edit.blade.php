...
Reg. No<input type="text" name="regno" id="regno" value="{{$student->regno}}" required><br><br>
Name&nbsp;&nbsp;&nbsp;<input type="text" name="name" id="name" value="{{$student->name}}" required><br><br>
...
Age&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="age" id="Age" value="{{$student->age}}" required><br><br>
Email&nbsp;&nbsp;<input type="email" name="email" id="email" value="{{$student->email}}" required><br><br>
Phone&nbsp;&nbsp;<input type="number" name="phone" id="phone" value="{{$student->phone}}" required><br><br>
Address<textarea name="address" id="address" row="4" cols="50" required>{{$student->address}}</textarea>
<br><br>
